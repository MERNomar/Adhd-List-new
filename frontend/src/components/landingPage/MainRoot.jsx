...
return (<>
    ...
    <NavLink className="border-l-2 border-[#ffffff3a] pl-2 "><Button variant="text" color="primary">Login</Button></NavLink>
    <NavLink className="ml-3"><Button variant="contained"><Link to='todos/all' >Signup</Link></Button></NavLink> 
    </div>
    </>
)}
